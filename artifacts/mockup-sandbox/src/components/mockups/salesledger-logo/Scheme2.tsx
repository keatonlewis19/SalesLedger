const SCHEME = {
  name: "Color Scheme 2 — Ocean Blue",
  charcoal: "#333333",
  primary: "#007696",
  accent: "#94404C",
  highlight: "#81C1D2",
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center gap-10 p-8">
      ...
      <div className="w-full max-w-sm rounded-2xl shadow-md p-8 flex flex-col items-center gap-5" style={{ backgroundColor: charcoal }}>
        ...
        <div className="flex items-baseline gap-0.5">
          ...
          <span className="text-4xl font-black tracking-tight" style={{ color: highlight }}>Ledger</span>
        </div>
      ...
      <div className="flex gap-6">
        ...
        <Swatch color={primary} label="Ocean" />
        <Swatch color={accent} label="Burgundy" />
