...
const LeadBody = z.object({
  ...
  leadOwnership: z.enum(["Agency BOB", "Self-Generated"]).optional().nullable(),
  leadSourceId: z.number().int().optional().nullable(),
  state: z.string().optional().nullable(),
  county: z.string().optional().nullable(),
  zip: z.string().optional().nullable(),
  marketplace: z.enum(["Yes", "No"]).optional().nullable(),
  householdCount: z.number().int().nonnegative().optional().nullable(),
  qualified: z.enum(["Yes", "No"]).optional().nullable(),
  principal: z.number().nonnegative().optional().nullable(),
  faceValue: z.number().nonnegative().optional().nullable(),
...
router.post("/leads", requireAuth, async (req: AuthRequest, res): Promise<void> => {
  ...
  const [lead] = await db
    ...
    .values({
      ...
      phone: data.phone,
      email: data.email,
      leadOwnership: data.leadOwnership ?? null,
...
router.patch("/leads/:id", requireAuth, async (req: AuthRequest, res): Promise<void> => {
  ...
  const updatePayload: Record<string, unknown> = {
    ...
    ...(data.leadOwnership !== undefined && { leadOwnership: data.leadOwnership }),
    ...(data.leadSourceId !== undefined && { leadSourceId: data.leadSourceId }),
    ...(data.state !== undefined && { state: data.state }),
    ...(data.county !== undefined && { county: data.county }),
    ...(data.zip !== undefined && { zip: data.zip }),
    ...(data.marketplace !== undefined && { marketplace: data.marketplace }),
    ...(data.householdCount !== undefined && { householdCount: data.householdCount }),
    ...(data.qualified !== undefined && { qualified: data.qualified }),
    ...(data.principal !== undefined && { principal: data.principal }),
    ...(data.faceValue !== undefined && { faceValue: data.faceValue }),
